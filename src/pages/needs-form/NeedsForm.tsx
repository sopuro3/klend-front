...
function createData(
  name: string,
  type: typeof String | typeof Number | typeof Boolean | typeof Date | typeof Array | typeof Object
) {
  return { name, type};
}
          ...
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell >
                ...
                <TextField required sx={{width:"100%"}} id="outlined-basic" label="入力必須" variant="outlined" />
